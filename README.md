...
Defined in `magic_presets.py` — add your own there.
...
- **Silver Age** (Marvel 1954, DC 1956 → 80s) — the acetate method, so
...
- **Bronze Age 70s** — same again, but `offset_angles: 0`: mid-70s the
